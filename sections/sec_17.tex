...
\sol{
  ...
  In fact, this is true for any sequence for which the range the sequence  $\braces{x_n \where n \in \pints}$ is infinite.
...
\sol{
  ...
  \qproof{
    ...
    Since $U$ was an arbitrary neighborhood, this shows that $0$ is in $\clK$ by Theorem~17.5a.
  ...
  \qproof{
    ...
    This shows that $x$ is not in $\clK$ by Theorem~17.5b.
  ...
  \qproof{
    ...
    This shows that $K$ intersects $U$ so that $x$ is in $\clK$ by Theorem~17.5a since $U$ was an arbitrary neighborhood.
  ...
  \qproof{
    ...
    Thus $B$ intersects $K$.
    Since $B$ was any neighborhood of $x$ it follows from Theorem~17.5b that $x \in \clK$.
    ...
    Hence by Theorem~17.5b we have that $x \notin \clK$.
...
\sol{
  ...
  \qproof{
    ...
    Either way it follows from Theorem~17.5b that $x \notin \clA$.
...
\sol{
  ...
  \qproof{
    ...
    This shows that $x \times y$ is a not in $\closure{E}$ by Theorem~17.5b.
...
\sol{
  ...
  \qproof{
    ...
    This shows that $U$ does not intersect $X - A$, which suffices to show that $x$ is not in the closure of $X - A$ by Theorem~17.5a.
  ...
  \qproof{
    ...
    This shows that $x$ is not in $\closure{X-U}$ by Theorem~17.5a, which is a contradiction since we know it is.
    ...
    Thus, by Theorem~17.5a, there is a neighborhood of $V$ of $x$ that does not intersect $X - U$.
  ...
  \qproof{
    ...
    Hence $V$ intersects $U$ so that $x \in \clU$ by Theorem~17.5a.
...
\sol{
  ...
  We then have from Exercise~17.19c that $\Bd{B} = \clB - B = \braces{x \times y \where x = 0} \cup \braces{x \times y \where x > 0 \text{ and } y = 0}$.
  ...
  Thus $\Int{D} = \es$ so that $\closure{D} = \Int{D} \cup \Bd{D} = \es \cup \Bd{D} = \Bd{D}$ by Exercise~17.19a, and hence $\Bd{D} = \closure{D} = \reals^2$.
...
\sol{
  ...
  \qproof{
    ...
    Then by Lemma~17.5a there is an open set $U$ containing $x$ where $U$ does not intersect $A$.
    ...
    Consider any neighborhood $U$ of $x$ so that $U$ intersects $A$ by Lemma~17.5a.
  ...
  \end{lem}
  \qproof{
    (a) This was shown in Exercise~17.6a.
