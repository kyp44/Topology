...
\sol{
  ...
  \qproof{
    ...
    It also follows from Exercise~5.3c that $A \times B = \es$ since $B$ is empty.
  ...
  \qproof{
    ...
    We then have that the composition $f \circ g$ is an injective function from $A$ to $\intsfin{n}$ by Exercise~2.4b since $f$ is injective as well (since it is a bijection).
