...
\sol{
  ...
  \qproof{
    ...
    Hence in either case $B$ has a largest element so that $n+1 \in A$ since $B$ was an arbitrary nonempty subset of $S_{n+2} = \braces{1, \ldots, n+1}$.
...
\sol{
  ...
  \qproof{
    ...
    Thus $S$ is a nonempty subset of positive integers so that it has a least element $m$ by the well-ordering property.
    ...
    However, this cannot be since $m$ is the least element of $S$ and yet $m^2 < m$.
  ...
  \qproof{
    ...
    Since also clearly $n' \in \pints$, we have that $n' \in S_{N'} = \braces{k \in \pints \where k < N'} = \braces{1, \ldots, N'-1}$.
