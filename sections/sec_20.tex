...
\sol{
  ...
  (a)
  \qproof{
    First, denote the partial sums by
    \gath{
    ...
    Then, to show that the series converges, it suffice to show that the partial sums are bounded, since convergence then follows from what will be shown in Exercise~21.11 part (a).
  }
}
