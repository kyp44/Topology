...
\sol{
  ...
  \begin{center}
    \begin{tikzpicture}[scale=2]
      % Coordinate grid
      \draw[step=1cm,\tikzgridclr,thin] (-1.5,-1.5) grid (1.5,1.5);

      % Set shape
      \filldraw[thick,dashed,fill=black,fill opacity=\tikzgrayopac] (-1,0) -- (0,1) -- (1,0) -- (0,-1) -- cycle;
  ...
  First we show that the metric topology induced by $d'$ is finer than that induced by $\r$.
  ...
  This suffices to show that the metric topology induced by $d'$ is finer than that induced by $\r$ by Lemma~20.2.
